...
딥러닝에서는 PyTorch나 TensorFlow를 많이 사용하지만, 전통적인 머신러닝에서는 Scikit-learn이 사실상 표준 라이브러리라고 할 수 있다.

이번 글에서는 강의를 들으며 정리한 내용을 바탕으로

- Scikit-learn이 무엇인지
- 머신러닝 프로젝트에서 어떤 역할을 하는지
- 자주 사용하는 핵심 기능은 무엇인지를 정리해보았다.
...
덕분에 편하게 머신러닝 모델을 빠르게 구현하고 실험할 수 있다.
...
Scikit-learn 라이브러리는 이 전체 과정을 매우 쉽게 구현할 수 있도록 다양한 도구를 제공한다.
...
### 데이터 전처리
- ⏳ [Kaggle Taxi Fare 데이터를 활용한 EDA](/posts/EDA/)
