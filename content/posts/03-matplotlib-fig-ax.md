...
> 📓 **실습 노트북 전체**: [다운로드 (.ipynb)](/notebooks/matplotlib-fig-ax.ipynb) · [브라우저에서 보기 (nbviewer)](https://nbviewer.org/github/heo-aio/heo-aio.github.io/blob/main/static/notebooks/matplotlib-fig-ax.ipynb)
>
